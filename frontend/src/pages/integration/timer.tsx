...
export default function IntegrationTimerPage() {
  ...
  return (
    <>
      <Seo
        title="Referee Lights · Integration Timer"
        description={displayMessages.metaDescription ?? 'External integration timer.'}
        canonicalPath="/integration/timer"
        noIndex
      />
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 bg-black px-6 py-12 text-center text-white">
      ...
      <p className="max-w-xl text-xs text-white/50">
        {integration.exampleLabel}: <code>/integration/timer?externalUrl=https://easyliftersoftware.com/referee/lights?meet=3NJH7Y53</code>
      </p>
    </main>
  );
}
